...
public:
	// Constructor
	LogisticRegression(const std::vector<std::vector<float>>& features, const std::vector<bool>& targets, const int& numOfFeatures, const int& numOfDataPoints, const float& regularizationParam);
